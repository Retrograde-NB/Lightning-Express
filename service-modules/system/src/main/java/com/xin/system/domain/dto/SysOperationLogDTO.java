 ...
 * @Date 2024/04/19 下午 9:26
 * @Version 1.0
 * @Remark 又是程序猿秃头的一天
 */
@ApiModel(value = "操作日志-请求参数")
public class SysOperationLogDTO {
    ...
    public SysOperationLogDTO(Long id, String title, Integer businessType, String method, String requestMethod, Integer operatorType, String operationName, String deptName, String operationUrl, String operationIp, String operationLocation, String operationParam, String jsonResult, Integer status, String errorMsg, Date operationTime, Long costTime) {
        this.id = id;
        this.title = title;
        this.businessType = businessType;
        this.method = method;
