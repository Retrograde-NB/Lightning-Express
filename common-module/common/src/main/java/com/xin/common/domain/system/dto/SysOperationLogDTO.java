...
public class SysOperationLogDTO {
    ...
    public SysOperationLogDTO(String title, Integer businessType, String method, String requestMethod, Integer operatorType, String operationName, String deptName, String operationUrl, String operationIp, String operationLocation, String operationParam, String jsonResult, Integer status, String errorMsg, Date operationTime, Long costTime) {
        this.title = title;
